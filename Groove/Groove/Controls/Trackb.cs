...
{
    public partial class Trackb : UserControl
    {
        Main m;
        Mixer.Bus mc;
        ...
        public Trackb(Main m, Mixer.Bus mc)
        {
            this.m = m;
            this.mc = mc;
            InitializeComponent();
        ...
        public void popOuts()
        {
            ...
            for (int i = m.m.Buses.IndexOf(mc) + 1; i < m.m.Buses.Count; i++)
            {
            ...
            for (int i = i = m.m.Buses.IndexOf(mc) + 1; i < m.m.Buses.Count; i++)
            {
